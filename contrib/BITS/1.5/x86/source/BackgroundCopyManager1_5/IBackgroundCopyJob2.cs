namespace BackgroundCopyManager1_5
{
    ...
    public interface IBackgroundCopyJob2 : IBackgroundCopyJob
    {
        ...
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
        void SetCredentials([ComAliasName("BackgroundCopyManager1_5.BG_AUTH_CREDENTIALS")] ref BG_AUTH_CREDENTIALS Credentials);
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
        void RemoveCredentials([ComAliasName("BackgroundCopyManager1_5.BG_AUTH_TARGET")] BG_AUTH_TARGET Target, [ComAliasName("BackgroundCopyManager1_5.BG_AUTH_SCHEME")] BG_AUTH_SCHEME Scheme);
    }
}
